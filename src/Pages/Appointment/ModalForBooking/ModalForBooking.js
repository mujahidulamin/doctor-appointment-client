...
const ModalForBooking = ({
  doctorForTreatment,
  setDoctorForTreatment,
  selectedDate,
  refetch,
}) => {
  const {
    ...
    price,
    email: doctorEmail,
  } = doctorForTreatment; //doctorForTreatment is in another name of appointment
      ...
      <div className="modal">
        <div className="modal-box relative">
          ...
          <form onSubmit={handleBooking} className="grid grid-cols-1 gap-4">
            ...
            <input
              type="submit"
              className="bg-[#38BDF8] text-lg text-white font-[Poppins] py-2  rounded hover:bg-[#07acf3]
                        duration-800 font-semibold cursor-pointer text-center w-full "
              value="Submit"
            />
          </form>
        </div>
