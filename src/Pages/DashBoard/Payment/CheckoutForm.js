...
const CheckoutForm = ({ booking }) => {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://doctor-appointment-server-university.vercel.app/create-payment-intent",
      {
        method: "POST",
        headers: {
  ...
  const handleSubmit = async (event) => {
    ...
    if (paymentIntent.status === "succeeded") {
      ...
      fetch(
        "https://doctor-appointment-server-university.vercel.app/payments",
        {
          method: "POST",
          headers: {
            "content-type": "application/json",
    ...
    <>
      ...
      {success && (
        <div>
          ...
          <p>
            Your Transection ID: <strong>{transactionId}</strong>
          </p>
        </div>
      )}
    </>
